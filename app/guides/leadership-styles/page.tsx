...
const STYLES: Style[] = [
  ...
  },
  {
    ...
    worstName: "The conflict-averse “nice boss”",
    worstNote: "so set on keeping everyone happy that underperformance is never confronted — until the best people leave to escape carrying the slack.",
  ...
  },
  {
    ...
    worstName: "Death by committee",
    worstNote: "so many voices are courted that no one ends up owning the call, and the decision quietly dies in the room it was made in.",
  ...
  },
  {
    ...
    worstName: "The relentless over-coach",
    worstNote: "turns every interaction into more feedback, until people hear “you're never quite good enough” and stop bringing their best.",
