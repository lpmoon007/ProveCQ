...
const GUIDES: { label: string; title: string; body: string; href: string; dark?: boolean }[] = [
  ...
  { label: "Free resource", title: "The hiring scorecard", body: "Rate candidates 1–5 on the behaviors that predict who delivers.", href: "/guides/hiring-scorecard", dark: true },
  ...
  { label: "Turnover", title: "What employee turnover really costs", body: "The visible cost is a fraction of the real one.", href: "/guides/cost-of-turnover" },
  { label: "Turnover", title: "Regretted attrition: the number that matters", body: "Total turnover hides the departures you'd take back.", href: "/guides/regretted-attrition" },
  { label: "Turnover", title: "How to reduce turnover in a small business", body: "You can't outspend big firms — so win on fit and fairness.", href: "/guides/reduce-turnover-small-business" },
  ...
  { label: "Founder leverage", title: "Founder dependence & key-person risk", body: "The quiet cap on your growth and your valuation.", href: "/guides/founder-dependence" },
  ...
  { label: "Leadership", title: "The 9 leadership styles, with examples", body: "Each style done well and badly — and when each one works.", href: "/guides/leadership-styles", dark: true },
  ...
  { label: "The research", title: "People decisions by the numbers", body: "What the data says about how often people bets fail — and the cost.", href: "/guides/people-decisions-by-the-numbers", dark: true },
  ...
  { label: "Comparison", title: "Prove vs. the 9-box grid", body: "A behavioral read beats a boardroom opinion.", href: "/guides/vs-9-box" },
  { label: "Comparison", title: "Prove vs. annual performance reviews", body: "Reviews look back. Prove predicts forward.", href: "/guides/vs-performance-reviews" },
  { label: "Comparison", title: "Why resumes & interviews miss follow-through", body: "Screen for behavior, not a good first impression.", href: "/guides/vs-resumes-interviews" },
